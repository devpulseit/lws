  ...
  const texts = {
    ...
    ru: {
      modal: {
        ...
        calculatorNote: "Попробуйте наш простой калькулятор: заполните пару полей — получите почти точную стоимость. Не переживайте, рядом с каждым пунктом есть значок «?» — он подскажет.",
